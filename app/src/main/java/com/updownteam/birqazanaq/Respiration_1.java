...
import com.updownteam.birqazanaq.Fft2;
...
public class Respiration_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_respiration_1);
    ...
    private Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if(Breath != 0 ){
                Intent i=new Intent(Respiration_1.this,RespirationResult.class);
