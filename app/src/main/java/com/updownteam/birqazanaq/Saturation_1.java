...
public class Saturation_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saturation_1);
    ...
    private  PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if(o2 != 0 ){
                Intent i=new Intent(Saturation_1.this,Saturation_result.class);
                i.putExtra("O2R", o2);
                i.putExtra("Usr", user);
                startActivity(i);
                finish();}
