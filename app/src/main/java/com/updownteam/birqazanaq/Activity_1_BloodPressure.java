...
import com.updownteam.birqazanaq.Fft;
...
public class Activity_1_BloodPressure extends Activity {
   ...
   // UserDB Data = new UserDB(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_1__blood_pressure);
        ...
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Hei = Double.valueOf(dataSnapshot.child("boy").getValue().toString());
                Wei = Double.valueOf(dataSnapshot.child("ceki").getValue().toString());
                Agg = Double.valueOf(dataSnapshot.child("age").getValue().toString());
                Gen = dataSnapshot.child("cins").getValue().toString();
                if(Gen.matches("Kişi")){
                    Q=5;
                }
                Toast.makeText(Activity_1_BloodPressure.this,String.valueOf(Hei),Toast.LENGTH_SHORT).show();
                Toast.makeText(Activity_1_BloodPressure.this,String.valueOf(Wei),Toast.LENGTH_SHORT).show();
                Toast.makeText(Activity_1_BloodPressure.this,String.valueOf(Agg),Toast.LENGTH_SHORT).show();
                Toast.makeText(Activity_1_BloodPressure.this,String.valueOf(Gen),Toast.LENGTH_SHORT).show();
            }
    ...
    private  PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if((SP != 0) && (DP != 0)){
                Intent i=new Intent(Activity_1_BloodPressure.this,BloodPressure_result.class);
                i.putExtra("SP", SP);
                i.putExtra("DP", DP);
                i.putExtra("Usr", user);
                startActivity(i);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(Activity_1_BloodPressure.this, Protect_activity.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
