...
public class HearthRateResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hearth_rate_result);
        ...
        SHR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(HearthRateResult.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                }
            }
        });
